  ...
  return (
    <div className="flex w-full text-gray-700 justify-evenly text-sm lg:text-base lg:justify-start lg:space-x-36 lg:pl-52 border-b">
      <div className="flex space-x-6">
        <HeaderOption icon={allSVG} title="All" selected />
        <HeaderOption icon={imagesSVG} title="Images" />
        <HeaderOption icon={videosSVG} title="Videos" />
        <HeaderOption icon={newsSVG} title="News" />
        <HeaderOption icon={mapSVG} title="Maps" />
      </div>
